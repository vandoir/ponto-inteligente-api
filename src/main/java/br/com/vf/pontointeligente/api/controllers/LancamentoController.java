package br.com.vf.pontointeligente.api.controllers;
...
import br.com.vf.pontointeligente.api.dtos.LancamentoDto;
import br.com.vf.pontointeligente.api.entities.Funcionario;
import br.com.vf.pontointeligente.api.entities.Lancamento;
import br.com.vf.pontointeligente.api.enums.TipoEnum;
import br.com.vf.pontointeligente.api.response.Response;
import br.com.vf.pontointeligente.api.services.FuncionarioService;
import br.com.vf.pontointeligente.api.services.LancamentoService;
...
/*
http://localhost:8080/api/lancamentos/funcionario/2
http://localhost:8080/api/lancamentos/funcionario/2?dir=ASC	
...
{
	"data" : "2017-07-18 09:00:00",
	"tipo" : "INICIO_TRABALHO",
	"descricao" : "Inicio do trabalho",
...
/*
http://localhost:8080/api/lancamentos/2
{
	"data" : "2017-07-18 17:30:00",
	"tipo" : "TERMINO_TRABALHO",
	"descricao" : "Termino do trabalho",
	"localizacao" : "3.123,4.321",
	"funcionarioId" : "2"
}	
 */
